...
class ProsesHapus extends StatefulWidget {
  final String id;
  const ProsesHapus({Key? key, required this.id }) : super(key: key);

  @override
  _ProsesHapusState createState() => _ProsesHapusState();
}

class _ProsesHapusState extends State<ProsesHapus> {
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: (_isLoading==true) ? (){} : () async {
                      ...
                      isLoading(true);
                      //delete database
                      FirebaseDatabase.instance.ref("data/admin/riwayat/${widget.id}").remove()
